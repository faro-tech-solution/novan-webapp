...
const ForgetPassword = () => {
  ...
  const handleUpdatePassword = async (e: React.FormEvent) => {
    ...
    try {
      ...
      console.log('Password update - Using stored token:', accessToken ? 'present' : 'missing');
      console.log('Password update - Using stored refresh token:', refreshToken ? 'present' : 'missing');
            ...
            <CardContent>
              <div className="text-center space-y-4">
                <p className="text-gray-600">
                  لطفا ایمیل خود را بررسی کنید و روی لینک بازیابی رمز عبور کلیک کنید.
                </p>
                <Button 
                  onClick={() => {
                    setEmailSent(false);
