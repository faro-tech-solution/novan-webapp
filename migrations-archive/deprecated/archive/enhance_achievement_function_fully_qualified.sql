...
COMMENT ON FUNCTION public.check_and_award_achievements(UUID) IS 'Enhanced version that checks for more achievements and returns debug logs, with all ambiguous column references fixed';
