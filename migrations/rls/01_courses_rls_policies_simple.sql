-- Simplified RLS Policies for Courses Table
...
-- Policy 4: Public can view active courses (optional)
...
-- Policy 5: Instructors can delete their courses
...
-- Policy 6: Admins can delete any course
