-- Test Simplified RLS Policies
-- This script tests the simplified RLS policies that avoid infinite recursion
...
SELECT 
  'Simplified RLS Policies Applied' as status,
  CASE 
    WHEN EXISTS (
...
-- Final status
SELECT '=== Simplified RLS Policy Test Complete ===' as status; 