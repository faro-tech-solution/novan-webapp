...
DROP POLICY IF EXISTS "Trainers can create conversation messages" ON exercise_submissions_conversation;
DROP POLICY IF EXISTS "Students can create conversation messages" ON exercise_submissions_conversation;
